...
\experience{IDCanopy}{Product Manager}{Oct 2024}{present}
{
    \achievement{
    Coordinated cross-functional teams to develop and scale identity verification and eKYC products for regulated industries. Led product documentation, client onboarding, and go-to-market readiness while aligning engineering and compliance efforts.
    }
}

\experience{susteam}{Co-Founder and CEO}{Sep 2022}{Jan 2025}
{
    \achievement{
...
\experience{LLP “Liga Holding”}{Real Estate Development Intern}{May 2021}{Oct 2021}{
    \achievement{
    Supported business transactions with partners in Turkey, using language skills to coordinate meetings and handle communications.
    }
}
...
\experience{Winner}{AIM Hackathon 2025}{AIM - AI Impact Mission}{Oct 2025}{}{
    \achievement{
    Built an AI agent capable of answering sustainability-related questions by retrieving and reasoning over data from Wikipedia, a structured database, and ESG PDF reports. Implemented a Retrieval-Augmented Generation (RAG) pipeline with explainability features to ensure transparency and accuracy in responses.
    }
